...
class CustomBetterPlayerControlsConfiguration {
  ...
  final bool enableBackwardEnd;

  final bool enableForwardEnd;

  final Widget fullScreenCenterDetails;

  final Widget channelIcon;

  // final File? channelLogo;
  final String title;
  final String? description;
  final String channelLogoUrl;

  const CustomBetterPlayerControlsConfiguration({
    ...
    this.progressBarBackgroundColor = Colors.blueGrey,
    this.controlsHideTime = const Duration(milliseconds: 5000),
    ...
    this.enableBackwardEnd = true,
    this.enableForwardEnd = true,
    ...
    this.forwardSkipTimeInMilliseconds = 60000,
    this.backwardSkipTimeInMilliseconds = 60000,
    this.loadingColor = Colors.white,
    this.loadingWidget,
    this.backgroundColor = Colors.black,
    this.overflowModalColor = Colors.black12,
    this.overflowModalTextColor = Colors.white,
    this.fullScreenCenterDetails = const SizedBox(),
    this.channelIcon = const SizedBox(),
  ...
  factory CustomBetterPlayerControlsConfiguration.white() {
    return const CustomBetterPlayerControlsConfiguration(
  ...
  factory CustomBetterPlayerControlsConfiguration.cupertino() {
    return const CustomBetterPlayerControlsConfiguration(
  ...
  factory CustomBetterPlayerControlsConfiguration.theme(ThemeData theme) {
    return CustomBetterPlayerControlsConfiguration(
